...
public class ShipOwner extends User{
    ...
    public ShipOwner(Long id, String email, String password, String name, String lastName, String adress, String city, String country, String phoneNumber, UserType userType, String registrationExplanation) {
    ...
    public ShipOwner(String email, String password, String name, String lastName, String adress, String city, String country, String phoneNumber, UserType userType, String registrationExplanation) {
