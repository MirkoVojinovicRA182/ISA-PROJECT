...
public class CottageReservationDTO {
    ...
    public CottageReservationDTO(LocalDateTime startTime, LocalDateTime endTime,Integer price, Integer clientId, Integer cottageId) {
    ...
    public CottageReservationDTO(LocalDateTime startTime, Integer price, Integer clientId, Integer cottageId) {
        this.startTime = startTime;
